...
const colors = [
  { id: 'black',  label: 'Matte Black',   hex: '#1a1a1a', border: '#1a1a1a' },
  { id: 'silver', label: 'Silver Mirror', hex: '#c0c0c0', border: '#aaa' },
  { id: 'red',    label: 'PUMA Red',      hex: '#c8102e', border: '#c8102e' },
];

const frameSizes = ['S', 'M', 'L'];

export default function EyewearInfo({ selectedColor, onColorChange, onOpenTryOn }) {
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 font-medium leading-relaxed">
          Precision-engineered for performance and style. Lightweight frames with UV400 protection and a wraparound fit built to stay locked in motion — from the track to the street.
        </p>
      </div>

      <div className="flex items-center gap-3">
        <span className="text-2xl font-black text-black">$195.00</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500">5.0 (12 reviews)</span>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs text-gray-500 font-medium">
            {colors.find(c => c.id === selectedColor)?.label || 'Select color'}
          </span>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-black uppercase tracking-widest text-black">Frame Size</span>
